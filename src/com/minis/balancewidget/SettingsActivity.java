...
public class SettingsActivity extends Activity {
    ...
    private View platformBlock(final String platform, final String name, int color, String hint) {
        ...
        if (nSites > 0) {
            TextView site = mkTextWrap(nSites > 1 ? "官网" : "控制台",
            ...
            site.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    LockDialog.choose(SettingsActivity.this, name,
                            siteLabels.toArray(new String[siteLabels.size()]),
                            new LockDialog.OnPick() {
                                public void pick(int which) { openUrl(siteUrls.get(which)); }
                            });
                }
            });
            head.addView(site);
